...
<style>
  ...
  .img-zoom-wrapper:hover .img-zoom {
    transform: scale(1.5); /* Skala wajar agar tidak pecah/meluber */
    cursor: zoom-in;
  }
...
<div class="modal fade" id="upload" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="<?=base_url('tagihan/upload_bukti')?>" method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" name="upload" class="btn-modern">Simpan Bukti</button>
        </div>
      </form>
    </div>
  </div>
